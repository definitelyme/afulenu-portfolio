...
StackRouter get navigator => App.context.router;

StackRouter? innerNavigator(BuildContext context, PageRouteInfo route) =>
    AutoRouter.innerRouterOf(context, route.routeName);
...
class Helpers {
  ...
  String get currentRoute => router.current.path;
